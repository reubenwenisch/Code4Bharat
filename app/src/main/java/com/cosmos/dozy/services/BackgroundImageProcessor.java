...
import com.cosmos.dozy.activities.MainActivity;
...
public class BackgroundImageProcessor extends Service implements CameraBridgeViewBase.CvCameraViewListener2 {
...
//        li = (LayoutInflater) this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View myview = View.inflate(this,R.layout.activity_main,null);
        stopService = myview.findViewById(R.id.stop_tracking);
        stopService.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                BackgroundImageProcessor.this.stopSelf();
            }
        });

//        View myview = LayoutInflater.from(getApplicationContext()).inflate(R.layout.activity_main,null);
//        ViewGroup myview = (ViewGroup) li.inflate(R.layout.activity_main, null);
        ...
        mOpenCvCameraView = (JavaCameraView) myview.findViewById(R.id.fd_activity_surface_view);
